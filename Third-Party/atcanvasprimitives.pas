...
function ColorBlend(const c1, c2: UInt32; const A: UInt32): UInt32; inline;
...
// blend level: 0..255
function ColorBlend(const c1, c2: UInt32; const A: UInt32): UInt32;
begin
  {$PUSH}
  {$R-}{$Q-}
  Result := (((((c1 and $00FF00FF) * A) + ((c2 and $00FF00FF) * (256 - A))) shr 8) and $00FF00FF) or
            (((((c1 and $0000FF00) * A) + ((c2 and $0000FF00) * (256 - A))) shr 8) and $0000FF00);
  {$POP}
end;
